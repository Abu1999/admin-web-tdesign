...
const config = {
  // 默认地址
  baseURL: import.meta.env.VITE_ISMOCK === 'true' ? '/mock' : import.meta.env.VITE_APP_BASE_API,
  // 设置超时时间
...
class RequestHttp {
  ...
  public constructor(config: AxiosRequestConfig) {
    console.log(import.meta.env.VITE_ISMOCK, import.meta.env.VITE_APP_BASE_API)
